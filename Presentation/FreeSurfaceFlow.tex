...
\begin{frame}
 		\begin{figure}
 			\begin{subfigure}[c]{0.45\textwidth}
 		 	...
 		 	\end{subfigure} 		 	
 		 	 \begin{subfigure}[c]{0.45\textwidth}
 		 	      \includegraphics[width=1\textwidth]{Images/images1.jpg}
 		 	\end{subfigure}
 		 	
 		 	\vspace{1em}
 		 	
 			\begin{subfigure}[c]{0.45\textwidth}
 		 	      \includegraphics[width=1\textwidth]{Images/images2.jpg}
 		 	\end{subfigure}
 		 	 \begin{subfigure}[c]{0.45\textwidth}
 		 	      \includegraphics[width=1\textwidth]{Images/images3.jpg}
 		 	\end{subfigure}   
 		\end{figure}
\end{frame}	
...
\subsection{Free surface treatment}
	\begin{frame}{One empty neighbor}
		\begin{figure}
			\includegraphics[width=1\textwidth]{Images/one.pdf}
		\end{figure}			
		
	\end{frame}	
	
	\begin{frame}{Two empty neighbor-common corner}
			\includegraphics[width=0.49\textwidth]{Images/two1.pdf}

	\end{frame}	
	
	\begin{frame}{Two empty neighbor-opposite side}
			\includegraphics[width=0.49\textwidth]{Images/two2.pdf}

	\end{frame}	
	
	\begin{frame}{Three empty neighbor}
			\includegraphics[width=0.49\textwidth]{Images/three.pdf}
	\end{frame}	
		
	\begin{frame}{Four empty neighbor}
			\includegraphics[width=0.49\textwidth]{Images/four.pdf}
