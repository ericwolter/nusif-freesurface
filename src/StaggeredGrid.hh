...
public:
   ...
   const FlagArray & obs() const { return obs_; }

   real dx() const { return dx_; }
   real dy() const { return dy_; }

   real xSize() const { return xSize_/dx_; }
   real ySize() const { return ySize_/dy_; }
